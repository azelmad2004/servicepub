    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('citoyen', 'Citoyen'), ('agent', 'Agent Administratif'), ('admin', 'Administrateur')], default='citoyen', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actif', models.BooleanField(default=True)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='profil_citoyen', to=settings.AUTH_USER_MODEL)),
            ],
            options={
